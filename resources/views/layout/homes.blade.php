        ...
        <section id="slider" class="slider-parallax revslider-wrap ohidden clearfix">
            ...
            <div class="tp-banner-container">
                ...
                <li data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-delay="10000" data-saveperformance="off" data-title="Latest Collections" style="background-color: #F6F6F6;">
                    ...
                    data-endspeed="1000"
                    data-endeasing="Power4.easeIn" style=""><img src="/homes/images/slider/rev/shop/girl1.jpg" alt="Girl">
                    </div>
                ...
                <li data-transition="slideup" data-slotamount="1" data-masterspeed="1500" data-delay="10000"  data-saveperformance="off"  data-title="Messenger bags" style="background-color: #E9E8E3;">
                    ...
                    data-endelementdelay="0.1"
                    data-endspeed="1000"
                    data-endeasing="Power4.easeIn" style=""><img src="/homes/images/slider/rev/shop/bag.png" alt="Bag"></div>
                ...
                <div class="container clearfix">
                    ...
                    <div class="col-md-8 nopadding">
                        ...
                        <div class="col-md-6 noleftpadding bottommargin-sm">
                            <a href="#"><img src="/homes/images/shop/banners/2.jpg" alt="Image"></a>
                        </div>

                        <div class="col-md-6 noleftpadding bottommargin-sm">
                            <a href="#"><img src="/homes/images/shop/banners/8.jpg" alt="Image"></a>
                        </div>

                        <div class="clear"></div>

                        <div class="col-md-12 noleftpadding">
                            <a href="#"><img src="/homes/images/shop/banners/4.jpg" alt="Image"></a>
                        </div>

                    </div>

                    <div class="col-md-4 nopadding" style="color:black">
                        <h4>公告</h4>
                        <ul id='uls'>
                            @foreach($arr as $k => $v)
