    ...
    <div class="mws-panel-body no-padding">
        ...
        <form action="/admin/goods" method='post' class="mws-form" enctype='multipart/form-data'>
            <div class="mws-form-inline">
                ...
                <div class="mws-form-row">
                    <label class="mws-form-label">商品名1</label>
                    <div class="mws-form-item">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        ...
                        <input type="file" name='gpic[]' multiple class="fileinput-preview" style="width: 100%; padding-right: 84px;" readonly="readonly" placeholder="">
                    </div>
                </div>
