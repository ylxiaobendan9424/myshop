...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
    	...
    	<form action="/home/address" method="post" class="mws-form" enctype='multipart/form-data'>
		  ...
		  <div class="form-group">
		  	<label for="inputEmail3" class="col-sm-2 control-label">所在地</label>
			    <div class="col-sm-10">
					...
					<select id="s_province" name="address1"></select>  
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		     <textarea class="form-control" rows="3" placeholder="请输入详细地址" name="xxaddress"></textarea>
